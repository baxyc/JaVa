...
public static void main(String[] args) {
    ...
    class Infrastructure {
      ...
      public void searchCinema(){
        ...
        String text = "";
        while(check){
            text = scanner.inputString("Для поиска фильма введите название фильма или его часть, для завершения поиска введите -1");
            if(text.equals("-1")) check = false;
                ...
                if (movies.size() == 0) System.out.println("Не найдено не одного совпадения");
                else{
